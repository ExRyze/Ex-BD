...
class Animelist_model
{
  ...
  public function add($post) {
    $this->db->query("INSERT INTO {$this->table} (`id_anime`, `title_anime`, `alternative_title_anime`, `episodes_anime`, `description_anime`, `author_anime`, `date_release_anime`, `date_finished_anime`, `credits_anime`, `type_video_anime`, `resolution_anime`) VALUES(NULL, :title, ':alternative', ':episodes', ':description', ':author', NULL, NULL, ':credits', ':type', ':resolution');
    ");
